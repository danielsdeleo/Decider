...
* Persist (Save) with [http://github.com/wycats/moneta]Moneta. Pretty much any storage mechanism that's available in ruby is supported. Save to a database and implement distributed classification if you like.
